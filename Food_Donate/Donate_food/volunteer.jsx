...
const VolunteerRegistrationPage = () => {
  return (
    <html lang="en">
      <head>
        <title>Registration for Volunteer</title>
        <meta charset="utf-8" />
      ...
      <nav className="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="ftco-nav">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item active"><a href="volunteer.html" className="nav-link">Sign Up</a> </li>
            </ul>
          </div>
        </div>
      </nav>
        ...
        <div className="hero-wrap" style={{backgroundImage: "url('images/donate.jpg')"}} data-stellar-background-ratio="0.5">
          <div className="overlay"></div>
          <div className="container">
            <div className="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
              <div className="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <h1 className="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Sign up to be our Volunteer</h1>
                <p className="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span className="mr-2"><a href="index.html">Home</a></span> <span>Sign up</span></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            ...
            <div className="row block-9">
              <div className="col-md-6 pr-md-5">
                ...
                <h4 className="mb-4">1.Personal Information</h4>
                <form action="#">
                  ...
                  <div className="form-group">
                    <input type="gender" className="form-control" placeholder="Gender" list="gender" />
                    <datalist id="gender">
                        <option value="Male">Male</option>
                        <option value="Female">Female</option>
                        <option value="Rather Not To Mention">Rather Not To Mention</option>
                    </datalist>
                  </div>
                  <div className="form-group">
                  ...
                  <h4 className="mb-4">2.Address</h4>
                  <form action="#">
                    <div className="form-group">
                      <input type="text" className="form-control" placeholder="Flat no/Area" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      <input type="pin" className="form-control" placeholder="pin" />
                    </div>
                    <h4 className="mb-4">2.Availibility And Volunteer Assignment Preference</h4>
                    <form action="#">
                      <div className="form-group">
                        <h7>From</h7>
                      ...
                      <input type="Sign Up" value="Sign Up" className="btn btn-primary py-3 px-5" />
                    </form>
                  </form>
                </form>
              </div>
          ...
          <div className="container">
                ...
                <div className="ftco-footer-widget mb-4">
                  ...
                  <div className="block-23 mb-3">
                    <ul>
                      ...
                      <li><a href="#"><span className="icon icon-phone"></span><span className="text">+91 12345789</span></a></li>
            ...
            <div className="row">
              <div className="col-md-12 text-center">
                <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i className="icon-heart" aria-hidden="true"></i> by Contributors</p>
              </div>
            </div>
          </div>
        </footer>
